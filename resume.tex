...
\begin{document}
  ...
  \begin{onecolentry}
    \begin{highlights}
      ...
      \item Built a physics-guided generative AI pipeline producing \textbf{42,305 synthetic 3D lesions} and \textbf{279 longitudinal sequences}; improved lesion-volume estimation \textbf{$R^2$ from 0.78 to 0.85} on 40 held-out real images.
      \item Fine-tuned four depth-estimation models on synthetic 3D cNF data, reducing average depth RMSE by \textbf{72.9\%} (47.30 to 12.83 cm) on scans with simulated lesions.
    \end{highlights}
  \end{onecolentry}
